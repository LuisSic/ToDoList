  ...
  return (
    <div className="policy">
      <div className="policy-body">
        ...
        <p>
          Luis Sic built the Todo app as a Free app. This SERVICE is provided by
          Luis Sic at no cost and is intended for use as is. This page is used
          ...
          Conditions, which is accessible at Todo unless otherwise defined in
          this Privacy Policy.
        </p>
        <h4 className="heading-4">Information Collection and Use</h4>
        <p>
          For a better experience, while using our Service, I may require you to
          provide us with certain personally identifiable information, including
          but not limited to Public Information and email. The information that
        ...
        <h4 className="heading-4">Links to Other Sites</h4>
        <p>
        ...
        <h4 className="heading-4">Children’s Privacy</h4>
        <p>
        ...
        <h4 className="heading-4">Changes to This Privacy Policy</h4>
        <p>
          I may update our Privacy Policy from time to time. Thus, you are
          advised to review this page periodically for any changes. I will
          notify you of any changes by posting the new Privacy Policy on this
          page. This policy is effective as of 2021-04-03
        </p>
        <h4 className="heading-4">Contact Us</h4>
        <p>
          If you have any questions or suggestions about my Privacy Policy, do
          not hesitate to contact me at lantoni24@hotmail.com.
        </p>
        <p>
